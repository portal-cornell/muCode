...
from eval_rm import evaluate_bin as evaluate
...
def main(args: Args, dataset_config: DatasetConfig, model_config: ModelConfig):
    ...
    dataset = DatasetDict({f"{args.dataset_eval_splits}": Dataset.load_from_disk(f'{args.dataset_path}/{args.dataset_name}/{args.dataset_eval_splits}'),
                           f"{args.dataset_train_splits}": Dataset.load_from_disk(f'{args.dataset_path}/{args.dataset_name}/{args.dataset_train_splits}')})

    dataset_processor = BinaryDatasetProcessor(tokenizer=tokenizer, config=dataset_config)
